...
export default function ResultSection() {
  ...
  const diff =
    isFinished && currentBPM !== undefined ? currentBPM - songBPM : 0;
  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      <div className="flex gap-3 w-full">
        <div className="flex-1 flex flex-col items-center bg-bg-card rounded-2xl p-5 h-25 justify-center">
          ...
          {hasTapped && !hasLiveBPM && !isFinished && (
            <div className="flex items-end gap-1 h-25">
        ...
        <div
          className={clsx(
            "flex-1 flex flex-col items-center bg-bg-card rounded-2xl p-5 h-25 justify-center",
            isFinished &&
              isCorrectAnswer &&
              "animate-[confetti-burst_0.8s_ease-out]"
          )}
        >
          <span className="text-xs uppercase tracking-wider text-text-secondary font-medium mb-2">
            {t("actualBpm")}
            ...
            <div className="flex items-end gap-1">
              <span
                className={clsx(
                  ...
                  isCorrectAnswer &&
                    "text-success animate-[bounce-in_0.5s_ease-out] [animation-fill-mode:both]",
